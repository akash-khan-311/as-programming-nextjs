...
export async function POST(req) {
  ...
  const payload = new URLSearchParams({
    ...
    currency: "BDT",
    tran_id,
    success_url: `https://as-programming.vercel.app/api/payment/success?tran_id=${tran_id}&user_email=${session.user.email}&amount=${amount}&course_id=${course_id}`,
    fail_url: `https://as-programming.vercel.app/api/payment/fail?tran_id=${tran_id}`,
    cancel_url: `https://as-programming.vercel.app/api/payment/cancel?tran_id=${tran_id}`,
    ipn_url: "https://as-programming.vercel.app/api/payment/ipn",
    cus_name,
    cus_email,
    cus_phone,
    cus_add1,
